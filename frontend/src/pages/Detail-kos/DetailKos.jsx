            ...
            <div>
              <section className="w-[390px] pl-6 py-5 mt-10 ml-[62rem] shadow-2xl bg-white rounded-md">
                ...
                <div className="pt-4 flex">
                  <input
                    type="date"
                    className="rounded-sm w-[160px] h-[36px] text-lg p-2 border border-black"
                  />
                  <select
                    name=""
                    className="rounded-sm w-[160px] h-[38px] text-lg ml-5 p-1 border border-black"
                    value={pakets}
                    onChange={changePakets}
                  >
                          ...
                          <div className="mt-3">
                            {states.total && (
                              <div className="container mt-4 flex">
                                ...
                                <div className="pl-14">Rp. {states.total}</div>
                              </div>
                            )}
                          </div>
                        </div>
