        ...
        <div className="w-[388px] p-4 mb-3 mt-[-15px] ml-[-24px]">
          <div className="rounded-md border border-black p-3">
            <div className="container mt-4">Jika kamu bayar pakai DP :</div>
              {states.dp && (
                <div className="container mt-4 flex">Uang Muka (DP) :<div className="pl-28">Rp. {states.dp}</div></div>
              )}
              {states.pelunasan && (
                <div className="container mt-4 flex">Pelunasan :<div className="pl-40">Rp. {states.pelunasan}</div></div>
              )}
              ...
              {states.penuh && (
                <div className="container mt-4 flex">Pembayaran penuh :<div className="pl-24">Rp. {states.penuh}</div></div>
              )}
          ...
          <span className="mt-5" style={{ borderTop: "1px solid grey", display: "block", width: "100%" }}></span>
            <div className="mt-3">
                {states.total && (
                <div className="container mt-4 flex">Total Pembayaran Pertama :<div className="pl-14">Rp. {states.total}</div></div>
              )}
            </div>
        </div>
      </>
        ...
        <div className="pr-10 pl-10 mt-10">
          <div className="pl-5 border border-black rounded-md w-[850px]">
            <p className="mb-2 mt-3">
              Olive Paragon Mall Tipe A adalah kost yang memiliki area
              strategis. Semua fasilitas sudah lengkap. Kamar mandi di dalam.
              Termasuk layanan bersih bersih kamar gratis serta sampo dan sabun
              free refill. Hubungi kami segera untuk info kelengkapan layanan
              kos lainnya.
            </p>
          ...
          <div className="pl-5 border border-black rounded-md w-[850px] mt-8">
            ...
            <p className="mb-3">
              Kost Area Gajah Mada, Hayam Wuruk, Olive Paragon Mall Tipe A,
              Jakarta Pusat Kota
            </p>
          </div>
          <div className="pl-5 border border-black rounded-md w-[850px] mt-8">
