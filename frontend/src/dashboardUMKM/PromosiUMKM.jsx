        ...
        <div className="pl-6 container relative mt-24">
          ...
          <div className="mt-3 border border-gray-400 rounded-md px-2 py-2 pb-8 mb-5">
            ...
            <div>
              <div className="flex">
                <div className="flex-col">
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white mx-2 my-2">
                    <div className="flex items-center">
                      <img src={voucher} alt="" />
                      <div className="flex flex-col ">
                        <h1 className="text-[10px] px-2 font-bold">
                          Voucher Toko Kami
                        </h1>
                  ...
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white flex mx-2 my-2">
                    <div className="flex">
                      <img src={bag} alt="" />
                      <div className="flex flex-col">
                        <h1 className="text-[10px] px-2 font-bold">
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggleKombo} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
                  ...
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white flex mx-2 my-2">
                    <div className="flex">
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggleOngkir} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
                ...
                <div className="flex-col">
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white flex mx-2 my-2">
                    <div className="flex">
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggle} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
                  ...
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white flex mx-2 my-2">
                    <div className="flex">
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggleKoin} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
                ...
                <div className="flex-col">
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white mx-2 my-2">
                    <div className="flex">
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggleToko} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
                  ...
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white mx-2 my-2">
                    <div className="flex">
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggleFlashSale} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
                ...
                <div className="flex-col">
                  <div className="border border-gray-400 rounded-md px-2 py-2 bg-white mx-2 my-2">
                    <div className="flex items-center">
                      <img src={add} alt="" />
                      <div className="flex flex-col ">
                        <h1 className="text-[10px] font-bold px-2">
                          Voucher Toko Kami
                        </h1>
                        <p className="text-[8px] px-2">
                          Berikan Voucher diskon untuk Pembeli & Tingkatkan
                      ...
                      <div className="flex items-center">
                        <Button mr={5} onClick={onToggleVoucher} bg={"white"}>
                          <SlArrowRight />
                        </Button>
                        <Popover
                          returnFocusOnClose={false}
