      ...
      <div className="flex container ml-24">
        ...
        <div className="pl-6 container relative mt-24">
          <div className="bg-primary_70 w-full rounded-md h-[60px] flex justify-center items-center">
            <p className="text-[30px] text-white text font-bold">Dashboard Pemilik HUNIAN</p>
          </div>
          <div className="">
            <div className="border border-gray-300 px-4 py-5 pr-24 mt-3 mb-4">
              <h1 className="mb-6 text-xl font-bold">Edit Data Hunian</h1>
              <form action=""></form>
              <div className="mb-3">
              ...
              <Link to="/hunian/dashboardhunian">
                <button className="px-4 py-2 bg-primary_70 text-white rounded">Simpan</button>
              </Link>
            </div>
          </div>
        </div>
